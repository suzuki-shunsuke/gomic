...
type (
	...
	OSMock struct {
		...
		impl                   struct {
			...
			Mkdir func(name string, perm os.FileMode) (r0 error)
		}
	}
)
...
func NewOSMock(t *testing.T, cb gomic.CallbackNotImplemented) *OSMock {
	return &OSMock{
		t: t, name: "OSMock", callbackNotImplemented: cb}
}

// Getwd is a mock method.
func (mock OSMock) Getwd() (r0 string, r1 error) {
...
func (mock *OSMock) SetFuncGetwd(impl func() (r0 string, r1 error)) *OSMock {
...
func (mock OSMock) fakeZeroGetwd() (r0 string, r1 error) {
	return r0, r1
}

// Mkdir is a mock method.
func (mock OSMock) Mkdir(name string, perm os.FileMode) (r0 error) {
...
func (mock *OSMock) SetFuncMkdir(impl func(name string, perm os.FileMode) (r0 error)) *OSMock {
...
func (mock OSMock) fakeZeroMkdir(name string, perm os.FileMode) (r0 error) {
	return r0
}
