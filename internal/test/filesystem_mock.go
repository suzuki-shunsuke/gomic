...
type (
	...
	FileSystemMock struct {
		...
		impl                   struct {
			Exist          func(p0 string) (r0 bool)
			MkdirAll       func(p0 string) (r0 error)
			Write          func(p0 string, p1 []byte) (r0 error)
			GetWriteCloser func(p0 string) (r0 io.WriteCloser, r1 error)
			Getwd          func() (r0 string, r1 error)
		}
	}
)
...
func NewFileSystemMock(t *testing.T, cb gomic.CallbackNotImplemented) *FileSystemMock {
	return &FileSystemMock{
		t: t, name: "FileSystemMock", callbackNotImplemented: cb}
}
...
func (mock FileSystemMock) fakeZeroExist(p0 string) (r0 bool) {
	return r0
}
...
func (mock FileSystemMock) fakeZeroMkdirAll(p0 string) (r0 error) {
	return r0
}
...
func (mock FileSystemMock) fakeZeroWrite(p0 string, p1 []byte) (r0 error) {
	return r0
}
...
func (mock FileSystemMock) fakeZeroGetWriteCloser(p0 string) (r0 io.WriteCloser, r1 error) {
	return r0, r1
}
...
func (mock FileSystemMock) fakeZeroGetwd() (r0 string, r1 error) {
	return r0, r1
}
